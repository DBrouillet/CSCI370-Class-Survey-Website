"""
Django settings for csmsaleh project.
...
# Adding dotenv compatibility for Heroku deploy (postgres)
...
ALLOWED_HOSTS = ['collabfeedback.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'csmsaleh.wsgi.application'
...
# IF WORKING ON WINDOWS - UNCOMMENT THIS
DATABASES = {
    'default': {
...
# IF DEPLOYING TO HEROKU - UNCOMMENT THIS
# DATABASES = {}
